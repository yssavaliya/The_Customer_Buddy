...
<body class="bg-[url('/images/saturn_earth.jpg')] bg-cover">
  ...
  <a href="/next-page" class="absolute top-3/4 left-1/2 inline-block px-4 py-2 font-semibold text-white border-2 border-white rounded-lg hover:bg-transparent hover:border-white hover:text-white transition-all duration-300">
